...
CREATE TABLE user (user_id INT(8) NOT NULL AUTO_INCREMENT, email VARCHAR(40) NOT NULL, gender CHAR(1), type VARCHAR(20) NOT NULL, dob DATE, pass VARCHAR(30) NOT NULL, fname VARCHAR(40), mname VARCHAR(40), lname VARCHAR(40), PRIMARY KEY (user_id, email));
